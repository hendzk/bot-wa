...
async function zynxzoStart() {
    ...
    const cFimage = ["http://telegra.ph/file/9a332c815ad31956d5ce6.jpg"]
    ...
    zynxzo.ev.on('connection.update', async (update) => {
        ...
        try {
            ...
            zynxzo.sendMessage('6285668888189@s.whatsapp.net', {
    image: {
        url: `${gambarbanyak}`
        },
    caption: `❗ 𝗕𝗼𝘁 𝗭𝘆𝗻𝘅𝘇𝗼 𝗩𝟲.𝟬 𝗦𝘂𝗰𝗰𝗲𝘀 𝗖𝗼𝗻𝗻𝗲𝘁𝗶𝗻𝗴 𝗯𝗮𝗻𝗴 𝗡𝗼𝘅𝗺𝟬𝟬𝟳🥵🥶 🌥`
        })
                /*                say("ModsV3\n", {
                                    font: 'block',
                                    align: 'center',
                ...
                await console.log(color("\nCreate By zynxzoDeveloper\nYOUTUBE : zynxzoHosting\nTelegram : zynxzozhosting\n", `${randomcolor}`))
